...
<head>
    ...
    <style>
        ...
        h2 i { color:#f97316; margin-right:6px; }
        .row {
            display: flex;
            gap: 14px;
        }
...
<div class="container">
    <div class="form-card">
        ...
        <h2><i class="fa-solid fa-user-tie"></i>Owner Registration</h2>
        ...
        <form action="${pageContext.request.contextPath}/owners-ui/login" method="get">
